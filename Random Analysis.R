...
data[1:49,4:99]<-as.data.frame(matrix(sample(1:5,49*96,replace = T),49,96))
...
set.seed(42)            #Set seed in random analysis for reproducibility

randomresults=numeric()

for(l in 1:100)   
{
    #=====================
    #replacing responses by random data
    ...
    #randomresults will contain the result for 10 random analysis
    randomresults[l]=results[13,8]
}
mean(randomresults)
